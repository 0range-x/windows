...
typedef NTSTATUS(NTAPI* _NtAllocateVirtualMemory)(//ָ
...
DWORD GetAndSetSysCall(TCHAR* szFuncName) {
	...
	LPVOID CallAddr = (LPVOID)(FuncAddr + 4);   //e8
...
int main() {
	...
	GetAndSetSysCall((TCHAR*)"NtAllocateVirtualMemory");
	_NtAllocateVirtualMemory NtAllocateVirtualMemory = (_NtAllocateVirtualMemory)&FuncExample;
